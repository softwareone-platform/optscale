...
import { conditions, name, poolOwner, priority } from "@main/components/AssignmentRulesTable/columns";
import prepareData from "@main/components/AssignmentRulesTable/utils/prepareData";

...
const Day = ({ disabled, highlighted, outlined, filled, outsideMonth, outsideBounds, onClick, onHover, value }) => {
      ...
      >
        <Typography
          className={cx(classes.buttonText, {
            ...
            [classes.outsideMonthText]: outsideMonth,
            [classes.outsideBoundsText]: outsideBounds
          })}
          disabled={disabled}
        >
          {value}

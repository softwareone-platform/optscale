...
import FieldWithActionButton from "@main/components/DataSourceCredentialFields/FieldWithActionButton";
import Button from "components/Button";
import { TextInput } from "components/forms/common/fields";
import QuestionMark from "components/QuestionMark";

/**
 * Theme override of the upstream component. Identical except the External ID is optional:
 * SoftwareOne connects roles that predate external IDs, and upstream marks the input
 * `required`, which blocks the form for them. Validation (pattern, length) still applies.
 */

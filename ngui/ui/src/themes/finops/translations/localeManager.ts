import messagesEsES from "@theme/translations/es-ES/index";
import { currencyCodes } from "@main/utils/currency";
import messagesEnUS from "@theme/translations/en-US/index";

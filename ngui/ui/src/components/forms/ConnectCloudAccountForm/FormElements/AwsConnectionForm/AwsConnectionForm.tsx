...
import { AUTHENTICATION_TYPES, authenticationTypes } from "./AwsConnectionForm.constants";
...
const AwsTypeDescription = ({ messageId, linkUrl, linkDisplayBlock = false }: AwsTypeDescriptionProps) => {

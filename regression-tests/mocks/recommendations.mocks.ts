...
import { AWS_HQ_CLOUD_ACCOUNT_ID, AWS_MARKETING_CLOUD_ACCOUNT_ID, DEMO_USER_EMPLOYEE_ID, ORGANIZATION_ID } from './ids';
        ...
        matrix: {
          ...
          'sunflower.example': {
            ...
            'sunflower-ap-northeast-2': {
              duplicated_objects: 8,
              duplicates_size: 541545634,
              monthly_savings: 1.0293134053304479e-5,
            },
            'sunflower-us-west-1': {
              duplicated_objects: 0,
              duplicates_size: 0,
            ...
            'sunflower-infra-backup': {
              duplicated_objects: 4,
              duplicates_size: 264519146,
              monthly_savings: 5.027703776933449e-6,
            },
            'sunflower-us-east-1': {
              duplicated_objects: 8,
              duplicates_size: 541545634,
    ...
    '1739404800': [
      {
        ...
        cloud_account_name: e2e('AWS HQ'),
      },
      {
        cloud_account_id: AWS_MARKETING_CLOUD_ACCOUNT_ID,
...
const OptimisationsMock = {
  ...
  optimizations: {
    ...
    obsolete_ips: {
      ...
      items: [
        {
          cloud_resource_id: e2e('eip-gw80wgx89t7t7p3x2ah7y'),
        ...
        {
          cloud_resource_id:
            '/subscriptions/7a26946b-0d60-4c01-adce-b6269d527407/resourcegroups/sunflower_env/providers/microsoft.network/publicipaddresses/lily-pypi-1',
        ...
        {
          cloud_resource_id:
            '/subscriptions/318bd278-e4ef-4230-9ab4-2ad6a29f578c/resourcegroups/stop-not-deallocated-test_group/providers/microsoft.network/publicipaddresses/pip-stop-not-deallocated-test_group-vnet-germanywestcentral-default',

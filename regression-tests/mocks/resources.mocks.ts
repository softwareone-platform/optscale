...
import { AWS_HQ_CLOUD_ACCOUNT_ID, AZURE_CLOUD_ACCOUNT_ID, DEMO_USER_EMPLOYEE_ID, ORGANIZATION_ID } from './ids';

// ─── Mock payloads ──────────────────────────────────────────────────────────
const ResourceDetailsMock = {
  cloud_account_id: AWS_HQ_CLOUD_ACCOUNT_ID,
  cloud_resource_id: e2e('sunflower'),
  applied_rules: [
    {
  ...
  employee_id: DEMO_USER_EMPLOYEE_ID,
...
const RawExpensesMock = {
  ...
  raw_expenses: [
    {
      _id: e2e('69e0b4c2136fc91534b4124b'),
      start_date: '2026-04-14T00:00:00',
      cloud_account_id: AZURE_CLOUD_ACCOUNT_ID,
      resource_id:
        '/subscriptions/b6689fdb-ac8c-4116-8136-c7a179cb5be6/resourcegroups/nlpapp0827rgp/providers/microsoft.datafactory/factories/nlpapp0827df',
      _rec_n: 35332,
      benefitId: '',
      benefitName: '',
    ...
    },
    {
      ...
      meter_details: {
        meter_name: e2e('Cloud Orchestration Activity Run'),
        meter_category: 'Azure Data Factory v2',
        meter_sub_category: 'Azure Data Factory v2',
        unit: '1K',
        meter_location: '',
      ...
      clean_expenses: [
        {
          ...
          cloud_resource_id: e2e(
            '/subscriptions/01643997-4d64-4718-8114-15e488ce3f61/resourcegroups/nlpvs00515rgp/providers/microsoft.compute/virtualmachines/nlpvps00515'
          ),
          ...
          meta: {
            ...
            cloud_console_link:
              'https://portal.azure.com/#resource/subscriptions/01643997-4d64-4718-8114-15e488ce3f61/resourceGroups/NLPVS00515RGP/providers/Microsoft.Compute/virtualMachines/nlpvps00515/overview',
            ...
            vpc_id:
              '/subscriptions/01643997-4d64-4718-8114-15e488ce3f61/resourceGroups/nlpvne0100rgp/providers/Microsoft.Network/virtualNetworks/nlpvne0100',
            vpc_name: 'nlpvne0100',
            ram: 34359738368,
            architecture: 'x86_64',
          },
        ...
        },
        {
          cloud_account_id: '100efd88-28fb-49f1-946b-edbf78ad4650',
          cloud_resource_id:
            '/subscriptions/01643997-4d64-4718-8114-15e488ce3f61/resourcegroups/nlpvs00516rgp/providers/microsoft.compute/disks/nlpvs00516-disk-4',
          _first_seen_date: '2025-01-01T00:00:00',
          _last_seen_date: '2026-04-21T00:00:00',
          applied_rules: [
            {
          ...
          meta: {
            cloud_console_link:
              'https://portal.azure.com/#resource/subscriptions/01643997-4d64-4718-8114-15e488ce3f61/resourceGroups/NLPVS00516RGP/providers/Microsoft.Compute/disks/nlpvs00516-disk-4/overview',
            attached: true,
        ...
        },
        {
          ...
          meta: {
            flavor: 't4g.2xlarge',
            cloud_console_link:
              'https://console.aws.amazon.com/ec2/v2/home?region=eu-west-1#InstanceDetails:instanceId=i-06b92e5543302d718',
            stopped_allocated: false,
            last_seen_not_stopped: 1776692426,
            spotted: false,
            security_groups: ['sg-0a686dc1c44c9680a'],

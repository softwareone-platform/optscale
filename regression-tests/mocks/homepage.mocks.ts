...
import { ORGANIZATION_ID_HOMEPAGE } from './ids';
...
const OrganizationCleanExpansesMock = {
  data: {
    cleanExpenses: {
      ...
      clean_expenses: [
        {
          ...
          cloud_resource_id: e2e('sunflower-eu-fra'),
          applied_rules: [
            {
        ...
        },
        {
          ...
          meta: {
            ...
            flavor: 't2.large',
            cloud_console_link:
              'https://console.aws.amazon.com/ec2/v2/home?region=us-west-2#InstanceDetails:instanceId=i-0e464cfbf9650bd21',
            stopped_allocated: false,
            last_seen_not_stopped: 1742539238,
            spotted: false,
            security_groups: ['sg-0d99e8ecd70254ebe'],
        ...
        },
        {
          ...
          cloud_resource_id:
            '/subscriptions/318bd278-e4ef-4230-9ab4-2ad6a29f578c/resourcegroups/aqa/providers/microsoft.compute/virtualmachines/aqa-westus2-underutilized-instance',
          applied_rules: [
            {
          ...
          meta: {
            ...
            cloud_console_link:
              'https://portal.azure.com/#resource/subscriptions/318bd278-e4ef-4230-9ab4-2ad6a29f578c/resourceGroups/AQA/providers/Microsoft.Compute/virtualMachines/aqa-westus2-underutilized-instance/overview',
            stopped_allocated: false,
            last_seen_not_stopped: 1742539245,
            spotted: false,
            vpc_id:
              '/subscriptions/318bd278-e4ef-4230-9ab4-2ad6a29f578c/resourceGroups/aqa/providers/Microsoft.Network/virtualNetworks/aqavnet321',
            vpc_name: 'aqavnet321',
            security_groups: [
...
const OptimizationsMock = {
  total_saving: 4444.444444444,
  optimizations: {
    nebius_migration: {
      count: 0,
      saving: 0,
    ...
    volumes_not_attached_for_a_long_time: {
      ...
      items: [
        ...
        {
          cloud_resource_id:
            '/subscriptions/7a26946b-0d60-4c01-adce-b6269d527407/resourcegroups/sunflower_env/providers/microsoft.compute/disks/volume_from_snapshot_ubae4gee7luydbjgjbjvk5',
...
const OrganizationConstraintsMock = {
  organization_constraints: [
    {
      ...
      organization_id: ORGANIZATION_ID_HOMEPAGE,
      type: 'resource_quota',
      definition: {
        max_value: 10,
      },
    ...
    },
    {
      ...
      name: e2e('Buckets count in us-east'),
      organization_id: ORGANIZATION_ID_HOMEPAGE,
      type: 'resource_quota',
      definition: {
        max_value: 3,

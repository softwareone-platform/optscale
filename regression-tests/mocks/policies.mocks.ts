...
import { ORGANIZATION_ID, ORGANIZATION_ID_EVENTS } from './ids';
  ...
  organization_constraints: [
    {
      ...
      name: e2e('Instances tagging policy'),
...
// ─── Interceptions ──────────────────────────────────────────────────────────
/** The anomalies list renders constraints; it never requests filter options. */
...
/** The create form lists no constraints — it only offers filter options to build one. */
export const policyCreateFormInterceptions: InterceptionEntry[] = [
  {

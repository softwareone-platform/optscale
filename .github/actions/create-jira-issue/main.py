...
if not all([JIRA_URL, JIRA_USERNAME, JIRA_API_TOKEN, PROJECT, SUMMARY, ISSUE_TYPE]):
    print("::error::Missing required input parameters: jira_base_url, jira_user_email, jira_api_token, project, summary, issue_type.")
    exit(1)

...
def upgrade() -> None:
    ...
    op.create_table('tags',
                    ...
                    sa.Column(
                        'resource_type',
                        sa.Enum('user', 'organization', 'data_source', name='tagresourcetype'),
    ...
    op.create_index(
        op.f('ix_ffc-api-db_tags_resource_id'),
        'tags',
        ['resource_id'],
        unique=False,
        schema='ffc-api-db',

...
from app.dependencies.db import TagRepository, UserRepository
from app.dependencies.path import TagId, UserId
from app.enums import TagResourceType
from app.optscale.models import User
from app.pagination import LimitOffsetPage, paginate
from app.rql import RQLQuery, TagRules, UserRules
...
async def get_user_by_id(
    datasource: Annotated[User, Depends(fetch_user_or_404)],
):

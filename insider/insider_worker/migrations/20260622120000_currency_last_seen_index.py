...
"""
Adds an index on (currencyCode, last_seen) so the worker can load the previous
discovery's prices scoped to a single currency without scanning the whole
azure_prices collection.
"""

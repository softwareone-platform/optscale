...
test.describe('[MPT-18579] Perspective Tests', { tag: ['@ui', '@resources', '@perspectives', '@slow'] }, () => {
  ...
  test(
    '[232963] User can create an Expenses perspective and the chart options are saved and applied correctly',
    { tag: '@p2' },
    async ({ resourcesPage, perspectivesPage }) => {
  ...
  test(
    '[232964] User can create perspective for resource count and the perspective is saved and applied correctly',
    { tag: '@p2' },
    async ({ resourcesPage }) => {
      await resourcesPage.navigateToResourcesPageAndResetFilters();
  ...
  test(
    '[232966] User can create a perspective for the Meta chart and the perspective is saved and applied correctly',
    { tag: '@p2' },
    async ({ resourcesPage }) => {
      await resourcesPage.navigateToResourcesPageAndResetFilters();
  ...
  test(
    '[232967] User can create a perspective and delete it via the perspectives table',
    { tag: '@p2' },
    async ({ resourcesPage, perspectivesPage }) => {
  ...
  test(
    '[232970] Creating a perspective with an existing name shows a message stating that the original will be overwritten',
    { tag: '@p2' },
    async ({ resourcesPage }) => {
      await resourcesPage.navigateToResourcesPageAndResetFilters();
  ...
  test(
    '[232968] No perspectives message is displayed and perspectives button is hidden if there are no perspectives',
    { tag: '@p2' },
    async ({ resourcesPage, perspectivesPage }) => {
